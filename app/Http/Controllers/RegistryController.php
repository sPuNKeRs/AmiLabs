        ...
        return Datatables::of($patients)
            ...
            ->addColumn('action', function ($patients) {
                return '<div class="action-btn-center">
                            <a href="'.route('registry.patients.research.list', $patients->id).'" data-toggle="tooltip" data-placement="bottom" data-original-title="Список анализов" class="btn action-btn btn-warning waves-effect">
